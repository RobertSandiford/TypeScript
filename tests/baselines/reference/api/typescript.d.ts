...
declare namespace ts {
    ...
    type ClosedKeyword = ModifierToken<SyntaxKind.ClosedKeyword>;
    type OpenKeyword = ModifierToken<SyntaxKind.OpenKeyword>;
    type Modifier = AbstractKeyword | AccessorKeyword | AsyncKeyword | ConstKeyword | DeclareKeyword | DefaultKeyword | ExportKeyword | InKeyword | PrivateKeyword | ProtectedKeyword | PublicKeyword | OutKeyword | OverrideKeyword | ReadonlyKeyword | StaticKeyword | ClosedKeyword | OpenKeyword;
    ...
    interface TypeOperatorNode extends TypeNode {
        ...
        readonly operator: SyntaxKind.KeyOfKeyword | SyntaxKind.UniqueKeyword | SyntaxKind.ReadonlyKeyword | SyntaxKind.ClosedKeyword | SyntaxKind.OpenKeyword;
        readonly type: TypeNode;
    }
